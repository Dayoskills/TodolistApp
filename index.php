...
<table class= "table">
    <tbody class="fs- text-primary shadow">
        ...
        <tr>
           ...
           <td style="width: 10%;"> <a href="fetch_update.php?update=  <?php echo $row['id']; ?>" class="btn btn-outline-danger">Update</a></td>
           <!-- <td style="width: 10%;"> <a href="fetch_update.php?update= class="btn btn-outline-danger">Update</a></td> -->
        </tr>
        <?php $count++; } ?>
    </tbody>
</table>
